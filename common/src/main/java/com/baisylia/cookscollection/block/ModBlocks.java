...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(CooksCollection.MOD_ID, Registries.BLOCK);
    ...
    public static final Supplier<Block> SALTED_POINTED_DRIPSTONE = BLOCKS.register("salted_pointed_dripstone",
    ...
    private static <T extends Block> void registerBlockItem(String name, Supplier<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(), ModItems.properties()));
    }
